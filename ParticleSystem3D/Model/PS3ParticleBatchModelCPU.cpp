...
#include "PS3ParticleBatchModelCPU.hpp"
#include "../PS3ParticleSystem.hpp"
#include "../PS3ParticleSystemGPU.hpp"

PS3ParticleBatchModelCPU::PS3ParticleBatchModelCPU(int maxParticleCount, PS3ParticleSystem* ps)
...
//void PS3ParticleBatchModelCPU::ClearGPUParticles()
//{
//    _particleCountGPU = 0;
//    _vDataF.clear();
//}

void PS3ParticleBatchModelCPU::SetVertexAttributes()
{
    _renderer->SetupVertexDesc(); // 调用renderer的初始化顶点数据
}

void PS3ParticleBatchModelCPU::SetIndexData()
{
    int dst = 0;
...
void PS3ParticleBatchModelCPU::AddParticleVertexData(int index, PVData pvdata)
{
...
//void PS3ParticleBatchModelCPU::UpdateGPUParticles(float time, float dt)
//{
...
//vec3 PS3ParticleBatchModel::CalculateDeathPos(int index, float interval) // interval是粒子存活时间
//{
...
void PS3ParticleBatchModelCPU::RenderModel(int count)
{
    if (count <= 0)
        return;
